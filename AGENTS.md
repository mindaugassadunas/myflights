...
Context file for Codex. Read this before writing any code in this repo.
...
- **AI:** Codex API (Opus or Sonnet) for email parsing and recap generation
...
- Send to Codex API with a JSON schema for `Flight[]`
